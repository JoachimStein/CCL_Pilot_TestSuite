...
describe("Accounting Payments Full TestSuite", function () {
    const controller = new accountingContra();
    function receivedFlow() {
        controller.login();
        controller.navigate_to_contra();
        controller.create_contra();
